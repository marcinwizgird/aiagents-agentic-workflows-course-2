...
def feedstock_analyst_agent(feedstock_name):
    ...
    systemPrompt = """
                   ...
                   Provide a concise analysis of the given feedstock, highlighting its key components and general suitability for producing valuable refined products 
    ...
    userPrompt = f"Analyze the feedstock: {feedstock_name}"
    fedstockAnalysis = call_openai(systemPrompt, userPrompt)
    print(f"Feedstock Analysis requested: {fedstockAnalysis}")
    print(f"Feedstock analysis: {fedstockAnalysis}")
    return fedstockAnalysis
